...
export const getFollowingPosts = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`${BASE_URL}/posts`, {
      token
    },{
...
export const addComment = (id, comment,mention, commentId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      ...
      {
        comment,commentId,mention,token
      },
      {
        withCredentials: true,
      }
...
export const deletePost = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`${BASE_URL}/deletepost/${id}`, {
      token
    },{
      withCredentials: true,
    });
...
export const commented = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`${BASE_URL}/commentedpost`, {
      token
    },{
      withCredentials: true,
    });
